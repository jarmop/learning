...
# Compile
# gcc client/client-chatgpt2.c client/xdg-shell-protocol.c $(pkg-config --cflags --libs wayland-client) -o client-chatgpt2.elf
...
gcc -g -O0 \
  ...
  -o client-chatgpt2.elf client/client-chatgpt2.c client/xdg-shell-protocol.c \
