...
int main()
{
    ...
    // ------------------------------------
    GLuint shaderProgram = get_shader_program("coordinate_systems/shader2.vs", "coordinate_systems/shader2.fs");
...
void processInput(GLFWwindow *window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS) {
        ...
        glm_vec3_mulsubs(crossProd, cameraSpeed, cameraPos);
    }
    if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS) {
        ...
        glm_cross(cameraFront, cameraUp, crossProd);
        glm_normalize(crossProd);
        glm_vec3_muladds(crossProd, cameraSpeed, cameraPos);
    }
}
