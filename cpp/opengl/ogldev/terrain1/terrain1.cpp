...
int main() {
  ...
  GLuint shaderProgram =
      get_shader_program("coordinate_systems/shader.vs", "coordinate_systems/shader.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    mat4 projection;
    glm_perspective(glm_rad(fov), (float)SCREEN_WIDTH / (float)SCREEN_HEIGHT, 0.1f, 100.0f,
                    projection);
